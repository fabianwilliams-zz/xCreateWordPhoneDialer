...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface WordPhoneDialer_iOSViewController : UIViewController {
	void *__monoObjectGCHandle;
}
	...
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation WordPhoneDialer_iOSViewController { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_CallButton");
	}

	-(void) setCallButton:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_CallButton");
	}

	-(id) PhoneNumberText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_PhoneNumberText");
	}

	-(void) setPhoneNumberText:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_PhoneNumberText");
	}

	-(id) TranslateButton
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_TranslateButton");
	}

	-(void) setTranslateButton:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_TranslateButton");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "WordPhoneDialer.iOS.AppDelegate, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"WordPhoneDialer_iOSViewController", "WordPhoneDialer.iOS.WordPhoneDialer_iOSViewController, WordPhoneDialeriOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [WordPhoneDialer_iOSViewController class];
	__monotouch_class_map [5].handle = objc_getClass ("NSArray");
	__monotouch_class_map [6].handle = objc_getClass ("NSCoder");
	...
	__monotouch_class_map [15].handle = objc_getClass ("UIKit_UIControlEventProxy");
	__monotouch_class_map [16].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [17].handle = objc_getClass ("UITextField");
	__monotouch_class_map [18].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [19].handle = objc_getClass ("UITextPosition");
	__monotouch_class_map [20].handle = objc_getClass ("UITextRange");
	__monotouch_class_map [21].handle = objc_getClass ("UITextSelectionRect");
	__monotouch_class_map [22].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [23].handle = objc_getClass ("NSException");
	__monotouch_class_map [24].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [25].handle = objc_getClass ("__NSObject_Disposer");
